        ...
        return (
            <Container fluid className="p-0">
                ...
                <Modal isOpen={modal}>
                    ...
                    <ModalFooter>
                        <Button className={styles.deleteButton} onClick={() => deleteBlog()}>Delete Permanently</Button>
                        <Button className={styles.cancelButton} onClick={() => setModal(false)}>Cancel</Button>
                    </ModalFooter>
                </Modal>
                <Header
                ...
                <Container className="mt-5">
                    ...
                    <Container fluid className="p-0">
                        <Button className={styles.editButton} tag={Link} to={`/edit/${blog._id}`}><i className="fas fa-edit mr-2"> </i>Edit</Button>
                        <Button className={styles.deleteButton} onClick={() => setModal(true)}><i className="far fa-trash-alt mr-2"> </i>Delete</Button>
                        <hr />
                    </Container>
                    }
                    <ErrorText error={error} />
